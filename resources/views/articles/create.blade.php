        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                    {{ Form::label('image', 'Upload Image For Article:', ['class' => 'control-label', 'style' => 'margin-top:20px;']) }}
                    {{ Form::file('image') }}
                ...
                <div class="form-group{{ $errors->has('files') ? ' has-error' : '' }}">
                    {{ Form::label('files', 'Upload Multiple Files For Articles:', ['class' => 'control-label', 'style' => 'margin-top:20px;']) }}
