...
<div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h1>Edit Career</h1>
                <hr>
                {!! Form::model($career,['route' => ['career.update', $career->id], 'method' => 'PUT', 'files' => true]) !!}
                ...
                <select class="form-control select2-multi" multiple="multiple" name="interests[]" id="interests" required>
                ...
                <select class="form-control select2-multi" multiple="multiple" name="abilities[]" id="abilities" required>
                ...
                <select class="form-control select2-multi" multiple="multiple" name="values[]" id="values" required>
                ...
                <select class="form-control select2-multi" multiple="multiple" name="majors[]" id="majors" required>
                ...
                <div class="row" style="margin-top:30px;">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-success btn-lg btn-block">
                            <i class="fa fa-pencil" aria-hidden="true"></i> Edit Career
                        </button>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $("#interests").select2().val({!! json_encode($career->interests()->pluck('interest_id')) !!}).trigger('change');
    $("#abilities").select2().val({!! json_encode($career->abilities()->pluck('ability_id')) !!}).trigger('change');
    $("#values").select2().val({!! json_encode($career->work_values()->pluck('work_value_id')) !!}).trigger('change');
    $("#majors").select2().val({!! json_encode($career->majors()->pluck('major_id')) !!}).trigger('change');
</script>
@endsection