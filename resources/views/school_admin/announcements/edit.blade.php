    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <hr>
                {!! Form::model($announcement,['route' => ['school_admin_announcement.update', $announcement->id], 'method' => 'PUT', 'files' => true]) !!}
                ...
                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                    {{ Form::label('image', 'Update Image For Announcement:', ['class' => 'control-label', 'style' => 'margin-top:20px;']) }}
                    {{ Form::file('image') }}
                ...
                <div class="row" style="margin-top:30px;">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-success btn-lg btn-block">
                            <i class="fa fa-pencil" aria-hidden="true"></i> Edit Announcement
                        </button>
                    </div>
                </div>
